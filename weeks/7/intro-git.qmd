...
2.  `git status` to check the current status of your git environment
3.  `touch .gitignore` create a `.gitignore`
4.  `git add .` stage all un-staged files in the current directory
